...
public struct HorizontalContainerEdge: OptionSet, Sendable {
...
private struct WrapperPagerTabStripView<SelectionType, Content>: View where SelectionType: Hashable & Sendable, Content: View {
  private var content: Content
