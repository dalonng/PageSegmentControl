...
struct IndicatorBarView<SelectionType, Indicator>: View where SelectionType: Hashable & Sendable, Indicator: View {
  ...
  init(selection: Binding<SelectionType>, indicator: @escaping () -> Indicator) {
